...
inline
remote_rtimv::Colorbar colorbar2grpc( rtimv::colorbar cb )
{
...
inline
rtimv::colorbar grpc2colorbar(remote_rtimv::Colorbar colorbar)
{
...
inline
remote_rtimv::Colormode colormode2grpc(rtimv::colormode cm)
{
...
inline
rtimv::colormode grpc2colormode(remote_rtimv::Colormode colormode)
{
...
inline
remote_rtimv::Colorstretch stretch2grpc(rtimv::stretch cs)
{
...
inline
rtimv::stretch grpc2stretch(remote_rtimv::Colorstretch stretch)
{
