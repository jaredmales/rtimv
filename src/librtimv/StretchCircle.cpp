...
StretchCircle::StretchCircle( qreal x, qreal y, qreal width, qreal height, QGraphicsItem *parent )
...
bool StretchCircle::onHoverComputeSizing( QGraphicsSceneHoverEvent *e )
{
    ...
    if( m_cursorAngle <= 20 || m_cursorAngle > 340 || ( m_cursorAngle > 160 && m_cursorAngle <= 200 ) )
        m_sizing = szLeft;
    if( ( m_cursorAngle > 20 && m_cursorAngle <= 70 ) || ( m_cursorAngle > 200 && m_cursorAngle <= 250 ) )
        m_sizing = szBotr;
    if( ( m_cursorAngle > 70 && m_cursorAngle <= 110 ) || ( m_cursorAngle > 250 && m_cursorAngle <= 290 ) )
        m_sizing = szTop;
    if( ( m_cursorAngle > 110 && m_cursorAngle <= 160 ) || ( m_cursorAngle > 290 && m_cursorAngle <= 340 ) )
        m_sizing = szTopr;
